...
const ModalComponent = ({ className = "", }: Props) => {
  ...
  const machineName = useSelector((state: RootState) => state.machineData.editElement.data.machine_name, shallowEqual)
  const hostName = useSelector((state: RootState) => state.machineData.editElement.data.host_name, shallowEqual)
  const adminName = useSelector((state: RootState) => state.machineData.editElement.data.administrator, shallowEqual)
  const place = useSelector((state: RootState) => state.machineData.editElement.data.place, shallowEqual)
